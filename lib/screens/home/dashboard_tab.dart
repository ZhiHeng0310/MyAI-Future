              ...
              delegate: SliverChildListDelegate([
                  ...
                  children: [
                    ...
                    Expanded(
                      child: StatCard(
                        ...
                        label: 'Meds Today',
                        value: '${meds.takenToday}/${meds.medications.length}',
                        color: const Color(0xFF00C896),
                        sublabel: meds.adherenceRate == 1.0
                            ? 'All taken ✓'
                ...
                if (meds.medications.isNotEmpty) ...[
                  ...
                  ...meds.medications.map((med) => _MedTile(
                        med: med,
                        onLog: (taken) =>
                            context.read<MedicationProvider>().logDose(med.id, taken),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Day $daysSinceVisit of recovery',
            style: GoogleFonts.poppins(
          ...
          Text(
            '${(progress * 100).round()}% through standard recovery',
        ...
        children: [
              ...
              children: [
                Text(med.name as String,
                    style: const TextStyle(
                        fontWeight: FontWeight.w600, fontSize: 15, color: Color(0xFF0D1B2A))),
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              height: 32,
              decoration: BoxDecoration(
                color: taken ? const Color(0xFF00C896) : const Color(0xFFF2F4F7),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Icon(
